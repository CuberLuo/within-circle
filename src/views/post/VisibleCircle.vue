<template>
  <div>
    ...
    <van-action-sheet v-model:show="show" title="方圆几里可见" @close="cellValue = distanceValue">
      <div class="content">
        ...
        <div id="distance_tips">
          <span class="tips_span" v-if="sliderValue != 100"
            >{{ distanceValue }}={{ sliderValue * 50 }}米</span
          >
